...
| Belge | Tür | Konu |
|---|---|---|
| **Gömülü Sistemlere Giriş** | Yolculuk | Yeni mezuna oryantasyon: Zynq/ZCU111, boot & bellek, register, interrupt, I2C/SPI/UART, FreeRTOS, Vitis debug — 10 uygulamalı görev + mezuniyet görevi |
