/* ============================================================================
 * uart_ps.h — UART0 register-seviyesi mini sürücü modülü
 *
 * KOPYA NOTU: bu dosya lab02-uart/src/uart_ps.h'nin birebir kopyasıdır
 * (GÖREV 2'nin çözümü). Her lab klasörü bağımsız derlenebilsin diye
 * _gorev-zinciri.md sözleşmesi gereği kopya taşınır, referans/sembolik link
 * kullanılmaz. İçerik değişmedi.
 * ============================================================================ */
#ifndef UART_PS_H
#define UART_PS_H
