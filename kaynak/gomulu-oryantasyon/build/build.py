...
class Isleyici:
    ...
    def _gorev_karti(self, arg: str, govde: str) -> str:
        ...
        sinif_haritasi = {
            # English labels (current) + Turkish keys kept for backward safety
            "objective": "hedef", "hedef": "hedef",
            "prerequisites": "onkosul", "ön koşul": "onkosul", "on kosul": "onkosul",
            "steps": "adimlar", "adımlar": "adimlar", "adimlar": "adimlar",
            "success criteria": "basari", "success criterion": "basari",
            "başarı kriteri": "basari", "basari kriteri": "basari",
            "self-check": "sina", "self check": "sina",
            "kendini sına": "sina", "kendini sina": "sina",
            "if you get stuck": "takildiysan",
            "takıldıysan": "takildiysan", "takildiysan": "takildiysan",
            "deliverable": "teslim", "teslim": "teslim",
            "requirements": "gereksinimler", "gereksinimler": "gereksinimler",
            "acceptance criteria": "basari", "kabul kriterleri": "basari",
            "free design space": "serbest", "serbest alan": "serbest",
        }
