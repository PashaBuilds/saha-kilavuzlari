...
İş sayısı arttıkça süper döngü + ISR mimarisi bir kalıba oturur: her yeni
...
{{svg:sema-21-superdongu-rtos.svg|Şekil 21 — Bare-metal süper döngü ile FreeRTOS scheduler'ının yan yana karşılaştırması: "aynı anda" çalışma, tek çekirdekte hızlı zaman dilimlemedir.}}
...
ürettiği düzenli interrupt'tır. `configTICK_RATE_HZ` kullandığımız BSP'de
