...
| Parametre | Ekran | Anlamı | Yazılım karşılığı | Bölüm |
|---|---|---|---|---|
| Çekirdek özellikleri | [Ekran 31](#ekran-31)/[32](#ekran-32) | Çarpıcı/bölücü/FPU/cache VAR-YOK | `XPAR_MICROBLAZE_USE_HW_MUL` vb. → derleyici kararları | [9](#09-microblaze) |
| İşlemci saati | [Ekran 31](#ekran-31) | 100 MHz (clk_wiz) | `XPAR_CPU_CORE_CLOCK_FREQ_HZ=100000000` | [9](#09-microblaze) |
| LMB bellek | [Ekran 33](#ekran-33) | 64K @ 0x0, ILMB+DLMB çift uzay | linker script ana bölgesi | [9](#09-microblaze) |
| Ek AXI BRAM | [Ekran 33](#ekran-33) | 8K @ 0xC000_0000 | linker'da ek veri bölgesi | [9](#09-microblaze) |
| MMI / updatemem | (şema 15) | BRAM fiziksel haritası | sentezsiz ELF gömme akışı | [9](#09-microblaze) |
| Uartlite baud | [Ekran 35](#ekran-35) | 115200 — donanımda sabit | `XPAR_AXI_UARTLITE_0_BAUDRATE`; SetBaudRate YOK | [9](#09-microblaze) |
| IIC SCL | [Ekran 37](#ekran-37) | 100 kHz | I2C zamanlaması; değişimi sentez ister | [9](#09-microblaze) |
| SPI oranı | [Ekran 36](#ekran-36) | SCK = AXI/2 = 50 MHz, Quad, STARTUP | flash erişim hızı/yolu | [9](#09-microblaze) |
| GPIO genişlik | [Ekran 38](#ekran-38) | 4 bit, all-output, kesmeli | `XGpio` yazma maskesi sınırı | [9](#09-microblaze) |
| Timer | [Ekran 39](#ekran-39) | 32-bit, çift kanal, PWM | `XPAR_AXI_TIMER_0_CLOCK_FREQ_HZ` | [9](#09-microblaze) |
| Kesme ID'leri | [Ekran 34](#ekran-34) | concat sırası = ID (0'dan) | `XPAR_..._AXI_INTC_*_INTR`, `XIntc_Connect` | [9](#09-microblaze) |
| Uzak adresler | [Ekran 33](#ekran-33) | uartlite 0x4060_0000, timer 0x41C0_0000… | `XPAR_*_BASEADDR` | [9](#09-microblaze) |
