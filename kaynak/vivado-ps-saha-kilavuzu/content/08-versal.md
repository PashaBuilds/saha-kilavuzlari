...
rozet 1: CIPS, NoC ve DDR4 çıkışı tek karede; solda Sources'ta cips/noc/smc hücreleri.
]]
...
[[ekran: 22 | CIPS Re-customize — açılış
rozet 1: PS PMC ana bölümü — I/O, Clocking, Interrupts duraklarının kapısı.
rozet 2: Design flow şeması — CIPS'in PMC/PS/CPM alt dünyaları.
]]
...
rozet 1: PL0_REF_CLK — 333.333 MHz; PL IP'lerinin ve timer hesaplarının saati.
]]
...
rozet 1: DDR4 denetleyici parametreleri — MPSoC'ta PS içindeyken artık NoC'un sekmesi.
]]
