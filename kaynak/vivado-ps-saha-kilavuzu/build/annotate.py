...
SPEC = {
    ...
    # ---------- MicroBlaze pencere kareleri (2560x1400) ----------
    "30": {"boxes": [(0.435, 0.455, 0.35, 0.28, 1),
                     (0.828, 0.125, 0.075, 0.49, 2),
                     (0.955, 0.215, 0.042, 0.37, 3)]},
    "33": {"boxes": [(0.268, 0.170, 0.35, 0.135, 1),
                     (0.268, 0.320, 0.35, 0.055, 2)]},

    # ---------- MB Wizard (3616x2425) ----------
    "31": {"boxes": [(0.296, 0.310, 0.345, 0.103, 1),
                     (0.296, 0.421, 0.345, 0.170, 2),
                     (0.009, 0.145, 0.257, 0.430, 3)]},
    "32": {"boxes": [(0.306, 0.192, 0.334, 0.234, 1),
                     (0.306, 0.436, 0.334, 0.144, 2)]},

    # ---------- MB diyalog kareleri (2080x1561) ----------
    "34": {"boxes": [(0.340, 0.315, 0.305, 0.033, 1),
                     (0.320, 0.358, 0.505, 0.285, 2)]},
    "35": {"boxes": [(0.320, 0.308, 0.330, 0.033, 1),
                     (0.320, 0.272, 0.378, 0.032, 2)]},
    "37": {"boxes": [(0.320, 0.315, 0.400, 0.032, 1)]},
    "38": {"boxes": [(0.320, 0.318, 0.490, 0.172, 1),
                     (0.315, 0.878, 0.110, 0.030, 2)]},
    "39": {"boxes": [(0.318, 0.238, 0.285, 0.225, 1),
                     (0.168, 0.510, 0.095, 0.085, 2)]},

    # ---------- Quad SPI diyalog (2560x1826) ----------
    "36": {"boxes": [(0.260, 0.378, 0.206, 0.097, 1),
                     (0.250, 0.476, 0.248, 0.192, 2)]},
}
