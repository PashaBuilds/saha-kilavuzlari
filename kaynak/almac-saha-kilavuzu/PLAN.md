...
- Adlandırma: belge başlığı ve raf kartı **Antenden DTK'ya** (Darbe Tanımlayıcı Kelime — Türkiye ekip dilinde yerleşik); gövdede PDW korunur, Bölüm 0 ve sözlükte eşleme verilir (kullanıcı kararı).
